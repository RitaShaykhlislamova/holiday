...
import трекутникиImg from "./../../img/icons/трекутники.svg";
const Brandshouse = () => {
    return ( 
         ...
         <div className= "text">Дата заїзду</div>
            <div className= "block">
                ...
                <div className= "text1">Дата заїзду</div>
         ...
         <div className= "brands__btn"><span>Перевірити наявність <br/>вільних місць</span></div>
         ...
         <img className='default__Img1'  src={defaultImg1} alt="Default" />
            ...
            <img className="трекутники__Img" src={трекутникиImg} alt= "Трекутники" />
            </div>
